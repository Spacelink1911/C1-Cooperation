...
#define START_VEH_Pin GPIO_PIN_3
#define START_VEH_GPIO_Port GPIOA
#define LORA_M0_Pin GPIO_PIN_4
#define LORA_M0_GPIO_Port GPIOA
#define LORA_M1_Pin GPIO_PIN_6
#define LORA_M1_GPIO_Port GPIOA
#define IF_TX_Pin GPIO_PIN_4
#define IF_TX_GPIO_Port GPIOC
#define IF_RX_Pin GPIO_PIN_5
#define IF_RX_GPIO_Port GPIOC
...
#define LORA_TX_Pin GPIO_PIN_15
